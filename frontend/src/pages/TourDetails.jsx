...
//this is an static data later we will call our API and load our data from the database
              ...
              <div className="tour__content">
                ...
                <div className="tour__info">
                  ...
                  <div className="d-flex align-items-center gap-5">
                      <span className="tour__rating d-flex align-items-center gap-1">
                        ...
                        style={{color: 'var(--secondary-color)'}}></i> {avgRating===0 ? null: avgRating}
                        {
                          totalRating===0 ? (
                          "Not rated"
                          ) :
                ...
                <div className="tour__reviews mt-4">
                    ...
                    <Form onSubmit={submitHandler}>
                        ...
                        align-items-center gap-3 mb-4 rating__group">
                            ...
                            <div className="review__item">
                              ...
                              <div className="w-100">
                                ...
                                <div>
                                  <h5>Simon</h5>
                                  <p>
                                    {new Date("1-12-2023").toLocaleDateString(
                                      "en-Us",
                                      options
                                    )}
                                  </p>
